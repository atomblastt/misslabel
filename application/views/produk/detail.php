...
<div class="flex-w flex-sb">
	...
	<div class="w-size14 p-t-30 respon5">
		<h1 class="product-detail-name m-text30 p-b-13">
			<?php echo $title ?>
		</h1>
			<?php 
			...
			<div class="block2">
				<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
					...
					<div class="block2-overlay trans-0-4">
								<a href="<?php echo base_url('produk/detail/'.$produk_related->slug_produk) ?>" class="btn btn-info btn-sm pull-right">
									Lihat Detil
								</a>
						...
						<div class="block2-btn-addcart w-size1 trans-0-4">
							...
							<?php if ($this->session->userdata('username') === ''): ?>
								<a href="<?php echo base_url('login') ?>" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
								Add to Cart
								</a>
							<?php else: ?>
