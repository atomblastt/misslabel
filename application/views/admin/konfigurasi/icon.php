...
<div class="form-group">
  <label class="col-md-3 control-label">Uplaod Icon Baru</label>
  <div class="col-md-8">
    <input type="file" class="form-control" placeholder="Icon" name="icon" value="<?php echo $konfigurasi->icon ?>" required>
    Icon Lama: <br>
     <img src="<?php echo base_url('assets/upload/image/'.$konfigurasi->icon) ?>" class="img img-responsive img-thumbnail" width="250">
  </div>
</div>
